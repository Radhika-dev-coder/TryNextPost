        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxWeightLimit = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "CourierServiceabilities",
                columns: table => new
                {
                    ServiceabilityId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CourierId = table.Column<long>(type: "bigint", nullable: false),
                    Pincode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourierServiceabilities", x => x.ServiceabilityId);
                    table.ForeignKey(
                        name: "FK_CourierServiceabilities_Couriers_CourierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TxnReference = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingPincode = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<long>(type: "bigint", nullable: false),
                    CourierId = table.Column<long>(type: "bigint", nullable: false),
                    AwbNumber = table.Column<long>(type: "bigint", nullable: false),
                    ShipmentType = table.Column<int>(type: "int", nullable: false),
                    PickupAddressId = table.Column<long>(type: "bigint", nullable: false),
                    DeliveryCustomerName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryMobile = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    DeliveryPincode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    Breadth = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CodSettlementId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShipmentId = table.Column<long>(type: "bigint", nullable: false),
                    SellerId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CODSettlements", x => x.CodSettlementId);
                    table.ForeignKey(
                        name: "FK_CODSettlements_Sellers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "Sellers",
                        principalColumn: "SellerId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CODSettlements_Shipments_ShipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NdrId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShipmentId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NDRS", x => x.NdrId);
                    table.ForeignKey(
                        name: "FK_NDRS_Shipments_ShipmentId",
                        column: x => x.ShipmentId,
                        principalTable: "Shipments",
                        principalColumn: "ShipmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RtoId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShipmentId = table.Column<long>(type: "bigint", nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RTOS", x => x.RtoId);
                    table.ForeignKey(
                        name: "FK_RTOS_Shipments_ShipmentId",
                        column: x => x.ShipmentId,
                        principalTable: "Shipments",
                        principalColumn: "ShipmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentTrackings", x => x.TrackingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CODSettlements_SellerId",
                table: "CODSettlements",
                column: "SellerId");

            migrationBuilder.CreateIndex(
                name: "IX_CODSettlements_ShipmentId",
                table: "CODSettlements",
                column: "ShipmentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourierServiceabilities_CourierId",
                table: "CourierServiceabilities",
                column: "CourierId");

            migrationBuilder.CreateIndex(
                name: "IX_CourierServiceabilities_CourierId_Pincode",
                table: "CourierServiceabilities",
                columns: new[] { "CourierId", "Pincode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourierServiceabilities_Pincode",
                table: "CourierServiceabilities",
                column: "Pincode");

            migrationBuilder.CreateIndex(
                name: "IX_NDRS_ShipmentId",
                table: "NDRS",
                column: "ShipmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ShippingPincode",
                table: "Orders",
                column: "ShippingPincode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_DeliveryPincode",
                table: "Shipments",
                column: "DeliveryPincode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_TxnReference",
                table: "Transactions",
                column: "TxnReference",
                unique: true,
                filter: "[TxnReference] IS NOT NULL");
